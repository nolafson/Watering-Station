...
// The next step is the coding for the project.  She will retrieve and install the coding into the Geekduino (Arduino). That is, when we can figure out the software mechanics to deliver coding to the project.... Is Github a vehicle for this?
